//1. Write  a function to convert Celsius to  Fahrenheit. The function should take a single argument, which is the temparature in Celsius.//
...
function findSmallestNum(arr) {
    let smallest = arr[0]; // think the first element is the smallest
